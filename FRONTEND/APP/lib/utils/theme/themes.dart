...
class AppTheme {
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    primaryColor: Colors.blue[600]!, // Main blue from login page
    primaryColorDark: Colors.blue[800]!, // Darker blue for contrast
    primarySwatch: Colors.blue,
    brightness: Brightness.light,
    // scaffoldBackgroundColor: Colors.blue[50]!, // Light blue background
    scaffoldBackgroundColor: Colors.white, // Light blue background
    ...
    colorScheme: ColorScheme.light(
      primary: Colors.blue[600]!, // Main blue
      secondary: Colors.blue[400]!, // Lighter blue for accents
      surface: Colors.white.withOpacity(0.2), // Glassmorphic surface
      background: Colors.blue[50]!, // Light blue background
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
        ...
        // Note: Flutter's ElevatedButton doesn't support gradients directly,
        // so you may need to wrap it in a Container with a gradient in the widget tree
      ),
    ),
  ...
  static ThemeData darkTheme = ThemeData(
    ...
    primaryColorDark: Colors.blue[900]!, // Darker blue for dark theme
    primarySwatch: Colors.blue,
    brightness: Brightness.dark,
    scaffoldBackgroundColor: Colors.blue[900]!, // Dark blue background
    appBarTheme: AppBarTheme(
      color: Colors.transparent,
      iconTheme: const IconThemeData(color: Colors.white),
      titleTextStyle: TextStyle(
