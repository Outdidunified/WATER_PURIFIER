...
class BackgroundCollectingTask extends ChangeNotifier {
  static BackgroundCollectingTask of(BuildContext context, {bool listen = true}) =>
      Provider.of<BackgroundCollectingTask>(context, listen: listen);
