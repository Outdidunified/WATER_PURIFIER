...
class _GetStartedPageState extends State<GetStartedPage>
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          // Bottom Button (Technician Only)
          Positioned(
            bottom: screenHeight * 0.05,
            left: screenWidth * 0.05,
            right: screenWidth * 0.05,
            child: _currentPage == 2
                ? _buildTechnicianLoginButton(context, screenHeight, theme)
          ...
          AnimatedBuilder(
            ...
            builder: (context, child) {
              return Transform.translate(
                offset: Offset(
                  0,
                  sin(_animationController.value * 2 * pi) * 3,
                ),
  ...
  Widget _buildTechnicianLoginButton(
      BuildContext context, double screenHeight, ThemeData theme) {
